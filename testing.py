...
def get_topic_change(lull, age):
    ...
    if (lull and topic_change_roll <= 90) or (lull == False and topic_change_roll <= 30):
        ...
        match new_topic:
            ...
            case "gossip": ins = "Have your character mention gossip about one or more acquaintances - don't have your character introduce this topic with the word \"gossip\", don't have your character repeat a previous a bit of gossip, and ensure that this new topic fits the current mood. "
            case "hobby": ins = "Have your character talk about something regarding their hobby - don't have your character introduce this topic with the word \"hobby\", don't have your character repeat a previous a bit about their hobby, and ensure that this new topic fits the current mood. "
